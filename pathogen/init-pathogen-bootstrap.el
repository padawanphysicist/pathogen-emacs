...
;; `which-key' is a minor mode that solves this by displaying a popup with all
;; possible key bindings that can follow your currently entered prefix.  It
;; provides an excellent, contextual way to discover shortcuts globally.
...
(use-package which-key
  ...
  ;;
  ;; By default, Which-key doesn't give much help for prefix-keys. It either
  ;; shows the generic description, "+prefix", or the name of a prefix-command,
  ;; which usually isn't as descriptive as we'd like.
  ;;
  ;; Here are some descriptions for the default bindings in `global-map' and
  ;; `org-mode-map'.
...
;; file browser, it treats directory listings as editable buffers where you can
;; copy, move, delete, and rename files using standard Emacs commands.
