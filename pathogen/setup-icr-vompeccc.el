;;; setup-icr-vompeccc.el --- Incremental Completing Read (ICR) substrate using VOMPECCC stack  -*- lexical-binding: t; -*-
...
(provide 'setup-icr-vompeccc)
;;; setup-icr-vompeccc.el ends here
