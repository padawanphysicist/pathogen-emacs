;;; pathogen-icr-avy-extensions.el --- ICR action extensions for Avy ;;; -*- lexical-binding: t; -*-

;; Copyright (C) 2026 Victor Santos
;; Author: Victor Santos
;; Version: 0.1.0
;; Package-Requires: ((emacs "27.1") (avy "0.5.0") (embark "0.1"))
;; Keywords: convenience, editing, matching
...
(provide 'pathogen-icr-avy-extensions)
;;; pathogen-icr-avy-extensions.el ends here
