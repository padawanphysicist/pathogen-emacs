...
;; ============================================
;; Public API - User-facing variables
;; ============================================
...
Use `pathogen-layers!' macro for clean configuration.")

(defvar pathogen-layer-pre-init-hook nil
  "Hook run before initializing each layer.
Functions are called with layer struct as argument.")
...
;; ============================================
;; Private/Internal variables (pathogen--)
;; ============================================
...
Examples:
  ...
  (let* ((layer-name (cond
         ...
         (layer-enabled (if (listp layer-spec)
                           (if (plist-member layer-spec :enabled)
                               (plist-get layer-spec :enabled)
                             t)
...
(message "Loaded functions module")
(provide 'functions)
