...
;;
;;(defun pathogen/set-smooth-scrolling ()
;;  ;; Smooth scrolling
;;  ;;
;;  ;;
;;  (setq
...
;;(setq custom-file (expand-file-name "custom.el" pathogen--emacs-directory))
;;
;;)
;;
;;(defun pathogen/ui-hooks ()
;;  ;; Custom hooks
...
;;
;;(defun pathogen/config-buitin-plugins ()
...
;;  )
;;
;;(message "Loaded Core Configuration")
;;
(provide 'core)
